...
namespace s1
{
    [CustomEditor(typeof(IP_Xbox_Airplane_Input))]
    public class IP_Xbox_Airplane_Input_Editor : Editor
    {
        #region Variables
        private IP_Xbox_Airplane_Input targetInput;
        #endregion

        #region BuiltInMethod
        void OnEnable()
        {
            targetInput = (IP_Xbox_Airplane_Input)target;
        }
